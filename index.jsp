...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Parasmani Trivedi</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - JavaScript Development</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Parasmani Trivedi, a passionate and skilled professional from Rae Bareli (Uttar Pradesh), 
					India, holds a Bachelor's degree in Computer Science and Engineering from Feroze Gandhi Institute Of Engineering 
					and Technology. My educational journey encompasses both Higher Secondary and Secondary School Certificates from New Standard 
					Public School IC, Rae Bareli.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Specializing in E-Learning solutions, I adeptly utilize HTML, CSS, JavaScript, Node.js, and Express.js to create scalable platforms.
					 Proficient in MySQL, I ensure robust database management, facilitating cost-effective corporate training and higher education solutions.
					  My comprehensive technical skills include C++, SQL, MySQL, jQuery, JSON, Ajax, React, and more, acquired through my ongoing Post Graduate Diploma in 
					  Advanced Computing (PGDAC) at CDAC Noida.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">My achievements span a 5-star rating in Python on HackerRank, 
					solving over 150 problems on GeeksforGeeks, and developing CarZone, a professional
					 car-selling website using HTML, CSS, and JavaScript.....</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://drive.google.com/file/d/1nEWvkQXeAu8INdy7CJUyUCPz24me_xTv/view?usp=sharing"> <i
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								...
								We've received your information. If you have any additional queries or need immediate assistance, 
								please don't hesitate to contact us via email. Thank you for reaching out!" <br /> <a
									href="https://trivedigulshan9454@gmail.com">trivedigulshan9454@gmail.com</a>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Hanumant Puram near Tripula<br />Lucknow Prayagraj Road <br /> Raebareli 229001
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						This page was created using Servlet, JSP, JDBC, and MySQL. 
						I extend special thanks to my friend and teacher for their invaluable 
						support during the development process.<a href="https://github.com/Parasmani29">gitHub</a> .
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy;Parasmani Trivedi Website 2023</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
